...
<!-- <h4 id="co"> AMAZON </h4> -->
	...
	<div class="form" > <button class="btnr"> <h4>LOGIN ACCOUNT  </h4> </button><br><br>
	<form method="POST" action="welcome.html" enctype="multi-form/data">
		...
		<button class="cancel"><a href="index.php">CANCEL </a></button><br>
		<span > <a href="reg.php" style="color:black">  Do not have account? </a> </span>
