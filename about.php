...
<!-- <h4 id="co"> AMAZON </h4> -->
	...
	<ul id="ula">			
		...
		<li><button id="btn"> <a href="#">HOME ACCESSORIES</a></button>  </li>
	</ul>
	</div>
...
Amazon is known for its disruption of well-established industries through technological innovation and mass scale.
 ...
 largest technology company by revenue.  </p>
	...
	<center>
	<div id="box"> 
	<img id="logo" src="images/Amlogo.jpg">
	<table>     
			<tr> 
			...
			<tr> 
				<td><b> FORMERLY </b> </td>
				<td> CADBARA, INC. (1994–95)</td>
			</tr>
			<tr> 
				<td> <b>FOUNDED</b> </td>
				<td> JULY 5, 1994; 25 YEARS AGO IN BELEVUE, WASHINGTON, UNITED STATES </td>
			</tr>
			<tr> 
				<td> <b>FOUNDER </b> </td>
				<td> JEFF BEJOS </td>
...
<footer>
		 <center> <p> All Rights &reg Reserved &copy; AMAZON Pvt Ltd </p> </center>
		 <button style="float:right;margin-top:-45px;"><a href="contact.php">CONTACT US </a></button>
